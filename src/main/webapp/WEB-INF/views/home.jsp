...
<head>
	...
	<!--favicon-->
    <link rel="icon" type="image/ico" href="<spring:message code="resources.ico.favicon.path" />"/>
...
<div id="tabs">
    ...
    <div id="tests">
		<h2>SEARCH</h2>
		<p>
			Test spectral database API
		</p>
		<ul>
			<li>
				<input id="searchQuery" type="text" value="search" />
			</li>
			<li>
				<a id="searchLink"  href="<c:url value="/search" />">POST /search</a>
			</li>	
		</ul>
		
		<h2>LANG</h2>
		<p>
			Test webapp lang (Current Locale : ${pageContext.response.locale})
		</p>
		<ul>
			<li>
			...
			<li>
				Current lang: <spring:message code="test.lang" text="ERROR" />
			</li>	
		</ul>
...
<!-- 		  </div> -->
    ...
    <div id="simple">
		<h2>Simple</h2>
		<p>
			See the <code>fr.metabohub.spectralDatabase.mvc.simple</code> package for the @Controller code
		</p>
		<ul>
			<li>
	...
	<div id="mapping">
		...
		<p>
			See the <code>fr.metabohub.spectralDatabase.mvc.mapping</code> package for the @Controller code
		</p>
		<ul>
			<li>
	...
	<div id="data">
		<h2>Request Data</h2>
		<p>
			See the <code>fr.metabohub.spectralDatabase.mvc.data</code> package for the @Controller code
		</p>
		<ul>
			<li>
	...
	<div id="responses">
		...
		<p>
			See the <code>fr.metabohub.spectralDatabase.mvc.response</code> package for the @Controller code
		</p>		
		<ul>
			<li>
	...
	<div id="messageconverters">
		...
		<p>
			See the <code>fr.metabohub.spectralDatabase.mvc.messageconverters</code> package for the @Controller code
		</p>	
	...
	<div id="views">
		...
		<p>
			See the <code>fr.metabohub.spectralDatabase.mvc.views</code> package for the @Controller code
		</p>
		<ul>
			<li>
	...
	<div id="convert">
		...
		<p>
			See the <code>fr.metabohub.spectralDatabase.mvc.convert</code> package for the @Controller code
		</p>
		<ul>
			<li>
	...
	<div id="validation">
		<h2>Validation</h2>
		<p>
			See the <code>fr.metabohub.spectralDatabase.mvc.validation</code> package for the @Controller code	
		</p>
		<ul>
			<li>
	...
	<div id="exceptions">
		...
		<p>
			See the <code>fr.metabohub.spectralDatabase.mvc.exceptions</code> package for the @Controller code	
		</p>
		<ul>
			<li>
	...
	<div id="redirect">
		<h2>Redirecting</h2>
		<p>
			See the <code>fr.metabohub.spectralDatabase.mvc.redirect</code> package for the @Controller code	
		</p>
		<ul>
			<li>
	...
	<div id="async">
		...
		<p>
		  See the <code>fr.metabohub.spectralDatabase.mvc.async</code> package for the @Controller code.
		</p>
		<ul>
		<li>
