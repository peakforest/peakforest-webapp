...
<div class="col-lg-12">
	...
	<div class="col-lg-4">
		...
		<ul class="list-group" style="max-width: 600px;">
			...
			<li class="list-group-item"><a id="openPhpMyAdmin" class="btn btn-primary" target="_blank" href="<spring:message code="peakforest.admin.phpmyadmin" text="https://pfemw3.clermont.inra.fr/phpmyadmin/index.php?server=3" />" type="button" style=""><i class="fa fa-database"></i> Open phpMyAdmin</a></li>
		</ul>
